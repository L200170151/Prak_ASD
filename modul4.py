...
c2=mhs.mhsTIF("rendra",23,"klaten",220000)
c3=mhs.mhsTIF("gusti",21,"jogja",260000)
c4=mhs.mhsTIF("aji",24,"klaten",250000)
c5=mhs.mhsTIF("gateng",26,"magelang",240000)
c6=mhs.mhsTIF("banget",21,"jakarta",250000)
c7=mhs.mhsTIF("pokoke",23,"solo",220000)
